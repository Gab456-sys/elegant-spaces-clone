...
<todo id="suite-keyboard-gallery">
Abilitare lightbox con navigazione tastiera nella gallery SUITE
Aprire la griglia in overlay con frecce sinistra/destra, ESC per chiusura e focus states accessibili.
</todo>

<todo id="suite-image-optimization">
Ottimizzare le immagini della pagina SUITE
Introdurre versioni responsive con dimensioni mirate e loading strategy per migliorare performance mobile.
</todo>

<todo id="suite-booking-provider-live">
Collegare provider reale (Smoobu/Lodgify) al mount #suite-booking-embed
Sostituire il fallback con iframe/script ufficiale mantenendo sizing e bordi editoriali già definiti.
</todo>

<todo id="suite-seo-metadata">
Aggiungere SEO metadata specifici per /suite
Definire title, description e Open Graph coerenti con la nuova pagina hospitality.
</todo>

<todo id="suite-gallery-swipe-mobile">
Aggiungere gesture swipe alla SUITE GALLERY su mobile
Consentire navigazione touch orizzontale mantenendo coerenza con frecce desktop e transizioni morbide.
</todo>
