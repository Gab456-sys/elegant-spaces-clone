    ...
    <>
      ...
      <div className="md:relative md:w-full md:px-6 lg:md:px-8 text-inherit">
        <div className="md:flex md:items-center md:justify-between md:gap-6 text-inherit">
          ...
          <div className="hidden md:flex md:items-center md:gap-6 md:leading-none md:mt-[4px] text-inherit">
            <button
              type="button"
              onClick={toggle}
              aria-label={t("nav.language")}
              aria-pressed={language === "en"}
              className="header-nav-link md:inline-flex md:items-center md:justify-center md:gap-1.5 md:text-[15px] md:tracking-[1.2px] md:leading-[15px] md:uppercase md:whitespace-nowrap text-inherit md:opacity-100 md:pointer-events-auto"
            >
            ...
            <button
              ...
              className={`header-nav-link md:inline-flex md:items-center md:justify-center md:text-[15px] md:tracking-[1.2px] md:leading-[15px] md:uppercase md:whitespace-nowrap md:transition-all md:duration-300 text-inherit ${
                isScrolled
                  ? "md:opacity-100 md:pointer-events-auto"
                  : "md:opacity-0 md:pointer-events-none"
              }`}
            ...
            <a
              href="#contatti"
              aria-label="Ricerca"
              className="header-nav-link hidden md:inline-flex md:items-center md:justify-center md:text-[15px] md:tracking-[1.2px] md:leading-[15px] md:uppercase md:whitespace-nowrap text-inherit"
            >
              <svg
                aria-hidden="true"
                viewBox="0 0 24 24"
                className="block h-[20px] w-[20px] text-current"
                fill="none"
