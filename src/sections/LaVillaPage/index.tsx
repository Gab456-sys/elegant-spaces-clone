      ...
      >
        <div className="mx-auto grid w-full max-w-[1680px] grid-cols-1 gap-10 px-6 py-20 md:grid-cols-12 md:gap-x-14 md:px-10 md:py-28 lg:px-16">
          ...
          <div className="md:col-span-6 md:col-start-7 md:self-center">
            ...
            <h2
              data-reveal-order={1}
              className="reveal reveal-editorial m-0 mt-5 max-w-[14ch] font-beausite_classic text-[40px] leading-[1.15] tracking-[-0.02em] text-stone-900 sm:text-[52px] md:text-[64px]"
            >
              {isEn
          ...
          <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 md:grid-cols-3 md:gap-6">
            {suites.map((suite, index) => (
              <a
                ...
                href={suite.href}
                data-reveal-order={index}
                className="reveal reveal-editorial group block no-underline"
              >
                <div className="overflow-hidden">
                  <img
                    src={suite.image}
                    alt={suite.name}
                    className="block h-[46svh] w-full object-cover transition-transform duration-700 ease-out group-hover:scale-105"
                  />
                </div>
                <div className="mt-5 flex items-start justify-between gap-4">
                  <div>
                    ...
                    <h3 className="m-0 mt-2 font-beausite_classic text-[22px] leading-[1.15] tracking-[-0.01em] text-stone-900 md:text-[26px]">
                      {suite.name}
                    </h3>
                    <p className="m-0 mt-3 max-w-[42ch] text-[15px] leading-[1.55] text-stone-800/90">
                      {suite.desc}
                    </p>
                  </div>
                  <span className="mt-2 shrink-0 text-[11px] uppercase tracking-[0.22em] text-stone-900 transition-opacity group-hover:opacity-60">
                    &rarr;
                  </span>
                </div>
              </a>
