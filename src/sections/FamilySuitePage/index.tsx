...
export const FamilySuitePage = () => (
  <>
    <RoomEntrance
      ...
      amenitiesContent={{
        it: [
          { icon: <BedIcon />, kicker: <>Riposo</>, title: <>Matrimoniale + singolo</>, body: <>Materassi in memory, biancheria in lino lavato, cambio ogni tre giorni.</> },
        ...
        en: [
          { icon: <BedIcon />, kicker: <>Sleep</>, title: <>Double + single</>, body: <>Memory foam mattresses, washed linen, changed every three days.</> },
