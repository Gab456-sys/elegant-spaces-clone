...
export type RoomEntranceData = {
  ...
  images: {
    ...
    foreground?: string;
    /**
     * Layer intermedio: un elemento a media distanza (pannello, testiera,
     * quinta) con i bordi già sfumati nel PNG. Sta tra fondale e primo piano
     * e scala più in fretta del fondo: è il differenziale di velocità a far
     * leggere la scena come stratificata.
     */
    mid?: string;
  };
...
export const roomEntrances: Record<string, RoomEntranceData> = {
  family: {
    ...
    images: {
      ...
      mid: "/img/mid-panel.png",
    },
    foregroundFit: { width: 41, grow: 34, bottom: -3, lift: 10 },
  },
