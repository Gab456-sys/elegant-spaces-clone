...
export const ComfortSuitePage = () => (
  <>
    <RoomEntrance
      ...
      amenitiesContent={{
        it: [
          { icon: <BedIcon />, kicker: <>Riposo</>, title: <>Matrimoniale 160</>, body: <>Materasso in memory, biancheria in lino lavato, cambio ogni tre giorni.</> },
          { icon: <UserPlusIcon />, kicker: <>Su richiesta</>, title: <>Letto aggiuntivo</>, body: <>Un terzo letto in camera senza rinunciare allo spazio di manovra.</> },
        ...
        en: [
          { icon: <BedIcon />, kicker: <>Sleep</>, title: <>160 double bed</>, body: <>Memory foam mattress, washed linen, changed every three days.</> },
          { icon: <UserPlusIcon />, kicker: <>On request</>, title: <>Extra bed</>, body: <>A third bed in the room without losing room to move.</> },
