...
export const LeadershipCard = (props: LeadershipCardProps) => {
  return (
    <div
      role="group"
      ...
      >
        <figure className="aspect-[8_/_11] bg-gray-900/10 box-border caret-transparent outline-[3px] relative no-underline w-full overflow-hidden">
          <img
            src={props.imageSrc}
            alt={props.imageAlt}
            className="reveal-media box-border caret-transparent grayscale-[1] h-full max-w-full object-cover outline-[3px] no-underline align-bottom w-full"
          />
        </figure>
