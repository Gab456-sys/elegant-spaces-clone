      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid md:grid-cols-3 gap-12 mb-20">
          <div className="md:col-span-2">
            <p className="eyebrow text-white/60 mb-6">{t("footer.subscribe")}</p>
            <form className="flex flex-col gap-4 max-w-xl" onSubmit={(e) => e.preventDefault()}>
              ...
              <select className="bg-transparent border-b border-white/30 py-3 text-sm focus:outline-none focus:border-white text-white/80">
                <option className="bg-dark">{t("footer.selectCountry")}</option>
              ...
              <div className="mt-4">
                <button className="pill text-white"><span>{t("footer.signup")}</span></button>
              </div>
            </form>
          </div>
          <div className="space-y-12">
            <div>
              <p className="eyebrow text-white/60 mb-4">{t("footer.enquire")}</p>
            ...
            <div>
              <p className="eyebrow text-white/60 mb-4">{t("footer.follow")}</p>
