    ...
    <section className="bg-background text-foreground px-6 md:px-10 py-24 md:py-32">
      <div className="max-w-7xl mx-auto">
        <div className="grid md:grid-cols-2 gap-12 mb-20 items-end">
          <div>
            <p className="eyebrow text-muted-foreground mb-6">{t("expertise.eyebrow")}</p>
            <h2 className="serif italic text-6xl md:text-8xl leading-none font-light">{t("expertise.title")}</h2>
          </div>
          <div>
            ...
            <a href="#" className="inline-flex items-center gap-3 eyebrow hover:gap-5 transition-all">
              {t("expertise.cta")} <ArrowRight className="h-3.5 w-3.5" strokeWidth={1.4} />
            </a>
          </div>
        </div>
